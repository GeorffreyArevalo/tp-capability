package com.pragma.bootcamps.capability.infrastructure.entrypoints.reactiveweb.exception;

import com.pragma.bootcamps.capability.domain.enums.ExceptionStatusCode;
import com.pragma.bootcamps.capability.domain.exceptions.CapabilityException;
import com.pragma.bootcamps.capability.infrastructure.entrypoints.reactiveweb.dtos.responses.BusinessResponse;
...
public class CustomErrorAttributes extends DefaultErrorAttributes {
    ...
    public Map<String, Object> getErrorAttributes(ServerRequest request, ErrorAttributeOptions options) {
        ...
        BusinessResponse<?> responseBody = switch (error) {
            case CapabilityException be -> HandlersResponseUtil.buildBodyFailureResponse(
    ...
    private int determineHttpStatus(Throwable error) {
        return switch (error) {
            case CapabilityException be -> be.getStatus();
